...
NUMBER:	call	NUMfb		;check if it is an ID type 'dddddf' or 'dddddb'
	jp	nc,ISID		;if yes, process the ID
	call	BACKUP
...
usechar:
	...
	ret
;
;	Validation of current char, in the given base
;	returns CARRY=1 : not valid
;		CARRY=0 : valid, value in A
;
BinVerif:
	cp	'0'
	jr	z,Ok
