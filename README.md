# Z80AS - last update on 18 March 2023 - increased jump optimization table to 512 (from 128)
...
Z80AS was obtained by assembling the Z80AS source files using Z80AS (self assembling assembler :)
